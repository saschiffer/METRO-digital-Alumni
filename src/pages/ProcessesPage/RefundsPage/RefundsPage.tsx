...
const tilesData = [
    { title: "Erstattungsbeleg",        icon: "beleg",          category: "Prozesse", to: "/home/prozesse/erstattungen/erstattungsbeleg"},
    { title: "Reisekosten & Spesen",    icon: "reisekosten",    category: "Prozesse", to: "/home/prozesse/erstattungen/reisekosten-spesen"},
];

export const RefundsPageComponent: React.FC = () => {
    ...
    return (
        <div className='containerRefundsPage'>
            <HeaderLogoutComponent/>
            <div className="container__bodyRefundsPage">
                <div className="bodyItemRefundsPage">
                    <div className="BreadcrumbsRefundsPage">
                ...
                <div className="bodyItemRefundsPage">
                    <div className="themeImageRefundsPage">
                        <div className="ImageRefundsPage">
                            <div className="decorationRefundsPage">

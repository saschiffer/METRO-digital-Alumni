// ExterneToolsPage.tsx
import React from 'react';
import './ExternToolsPage.css';
...
const tilesData = [
    { title: "Git",     icon: "git",    category: "Tools", to: "/home/tools/extern/git"},
    { title: "GitHub",  icon: "github", category: "Tools", to: "/home/tools/extern/github"},
    { title: "HackMD",  icon: "hack",   category: "Tools", to: "/home/tools/extern/hackmd"},
];

export const ExternToolsPageComponent: React.FC = () => {
    ...
    return (
        <div className='containerExterneToolsPage'>
            <HeaderLogoutComponent/>
            <div className="container__bodyExterneToolsPage">
                <div className="bodyItemExterneToolsPage">
                    <div className="BreadcrumbsExterneToolsPage">
                ...
                <div className="bodyItemExterneToolsPage">
                    <div className="themeImageExterneToolsPage">
                        <div className="ImageExterneToolsPage">
                            <div className="decorationExterneToolsPage">
